...
public LeLexer(Reader in) {
	this(new CharBuffer(in));
}
public LeLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public LeLexer(LexerSharedInputState state) {
	super(state);
	...
	literals.put(new ANTLRHashString("true", this), new Integer(35));
...
tryAgain:
	...
	public final void mOPLOG(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = OPLOG;
		int _saveIndex;
	...
	public final void mVG(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = VG;
		int _saveIndex;
	...
	public final void mIG(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = IG;
		int _saveIndex;
